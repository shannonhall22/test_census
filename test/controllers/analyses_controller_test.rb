...
class AnalysesControllerTest < ActionController::TestCase
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post :create, analysis: { agency: @analysis.agency, campaign_name: @analysis.campaign_name, user_name: @analysis.user_name }
    end
  ...
  test "should update analysis" do
    patch :update, id: @analysis, analysis: { agency: @analysis.agency, campaign_name: @analysis.campaign_name, user_name: @analysis.user_name }
    assert_redirected_to analysis_path(assigns(:analysis))
  end
